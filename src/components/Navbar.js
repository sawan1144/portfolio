...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed z-50 left-1/2 -translate-x-1/2 flex items-center justify-between will-change-[width,top,border-radius,background-color,box-shadow] ${isScrolled
